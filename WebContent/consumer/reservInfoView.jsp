...
<%}%>
    ...
    <div class="container"> 
		...
		<div>
		<ul>
		<li>체크인은 오후 2시 이후로 가능합니다.
		<li>체크아웃은 당일 오후12시 입니다.
		<li>체크아웃 초과시 요금이 부과될 수 있습니다.
		<li>방 선택은 불가하며, 방은 체크인 시 배정됩니다.
		<li>준비된 비품 외에는 별도의 요금이 청구됩니다.
		</ul>
		</div>
