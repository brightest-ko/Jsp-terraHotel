...
<%
	...
	session.setAttribute("loadpage", "/terra/NoticeBoardDetailAction.ro?num="+board.getN_num());
%>
...
function button_event(){//수정 이동
	...
	if (id==id2){ %>
	//확인		
	location.href="NoticeBoardModify.ro?num=num98 "	
		//location.href="NoticeBoardModify.ro?num=num98"	
...
function button_event2(){//삭제	
	...
	location.href="NoticeBoardDeleteCheckView.ro?num=num99"	
...
<input  type="button" value="목록" onclick="location='NoticeBoardListAction.ro'">
<%} else {%>			
<input  type="button" value="목록" onclick="location='NoticeBoardListAction.ro'">
