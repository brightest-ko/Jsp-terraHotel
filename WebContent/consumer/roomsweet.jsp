...
<%
session.setAttribute("loadpage", "/terra/consumer/roomsweet.jsp");
%>
<!doctype html>
<html lang="ko">
	<head>
...
<p>스위트 룸은 아늑한 분위기의 고급스럽고 품격 있는 공간으로 여유로운 휴식을 제공합니다. 라운지에서는 호텔 수석 조리장이 준비한 조식과 해피아워 서비스를 경험하실 수 있습니다.</p>
<br>
			<!-- 슬라이드바 -->
			<div id="myCarousel" class="carousel slide  roomimg" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="./roomimg/sweet1.jpg" alt="img1" class="img-responsive room" style="max-height: 500px;">
					</div>

					<div class="item">
						<img src="./roomimg/sweet2.jpg" alt="img2" class="img-responsive room" style="max-height: 500px;">
					</div>

					<div class="item">
						<img src="./roomimg/sweet3.jpg" alt="img3" class="img-responsive room" style="max-height: 500px;">
					</div>

					<div class="item">
						<img src="./roomimg/sweet4.jpg" alt="img4" class="img-responsive room" style="max-height: 500px;">
					</div>
				</div>
			...
			<hr>
			<img class="img-responsive room" src="./roomimg/sweetdetail2.jpg" alt="img1">
