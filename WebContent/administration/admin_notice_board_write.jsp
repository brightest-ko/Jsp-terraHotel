...
<script type="text/javascript">
			function pagemove(str) {
				if(str=="1"){ location.href="admin.jsp" }
			}
			function logout(){
...
function button_check(){
	...
	';
		...
		if (id == null) {
			...
			location.href = "NoticeBoardWrite.ro"
			//location.href="/NoticeBoardDeleteAction.ro"
		}
	}
</script>
 --%>
...
<body>
	...
	<div class="table-responsive">
		<div class="container">
			<h2>Notice 게시판</h2>
			<form action="./AdminNoticeBoardAddAction.ro" method="post" name="boardform">
				<table class="table table-bordered">
					<thead>
						...
						<tr>
							<th>제목</th>
							<td colspan="7"><input name="n_subject" type="text"
					...
					<tbody>
						<tr>
							...
							<td colspan="7" rowspan="6"><textarea name="n_content"
				...
				<td><input name="rev_file" type="file" accept="image/*" /></td> -->
					...
					<tr>
						<td>비밀번호</td>
						<td><input type="password" name="n_pw">8자 이하 입력</td>
					</tr>

				</table>
				<button type="submit" name="modify" value="등 록" class="btn btn-info">등록</button>
				<input
					type="submit" name="back" value="뒤 로"
					onclick="javascript:history.go(-1)" class="btn btn-default">
			</form>
		</div>
	</div>
	<br><br>
