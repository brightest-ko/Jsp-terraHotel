...
<body>
	...
	<div class="table-responsive">
		<div class="container">
			<h2>Qna 게시판</h2>
			<form action="./AdminQnaBoardAddAction.ro" method="post" name="boardform">
				...
				<button type="submit" name="modify" value="등 록" class="btn btn-info"  class="btn btn-default">등록</button>
				<input
