...
public class QnaBoardDeleteCheckView implements Action {
	public ActionForward execute(HttpServletRequest request,
		...
		if(!(id.equals(uid))) {
			...
			out.println(" location.href='./QnaBoardDetailAction.ro?num=" +num+"' ");
			out.println("</script>");
			out.close();
			return null;
		}
		...
		forward.setUrl("./consumer/qnadeletecheck.jsp");
		return forward;
